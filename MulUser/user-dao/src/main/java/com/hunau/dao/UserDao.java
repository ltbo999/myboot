...
public interface UserDao {
    ...
    //更新
    int updateuser(@Param("id") long id, @Param("name") String name, @Param("pwd") String pwd,@Param("sexy") String sexy, @Param("birthday") Date birthday,@Param("remark") boolean remark);
    //根据id删除用户
